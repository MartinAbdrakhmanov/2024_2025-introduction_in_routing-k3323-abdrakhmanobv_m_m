...
/routing bgp peer
add address-families=l2vpn name=peer1 remote-address=172.16.6.2 remote-as=\
    65500 update-source=loopback0
add address-families=l2vpn name=peer2 remote-address=172.16.3.2 remote-as=\
    65500 route-reflect=yes update-source=loopback0
add address-families=l2vpn name=peer3 remote-address=172.16.2.2 remote-as=\
    65500 route-reflect=yes update-source=loopback0
